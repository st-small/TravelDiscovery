...
//  TravelDiscovery
//
//  Created by Stanly Shiyanovskiy on 18.03.2021.
//
                    ...
                    VStack(alignment: .leading) {
                        ...
                        HStack {
                            ForEach(post.hashtags, id: \.self) { hashtag in
                                Text("#\(hashtag)")
                                    .foregroundColor(Color(#colorLiteral(red: 0.007921018638, green: 0.5458384156, blue: 1, alpha: 1)))
                                    .font(.system(size: 12, weight: .regular))
                                    .padding(.horizontal, 12)
                                    .padding(.vertical, 4)
                                    .background(Color(#colorLiteral(red: 0.9143946171, green: 0.9422872663, blue: 0.9855660796, alpha: 1)))
                                    .cornerRadius(20)
                            }
                        }
                        .padding(.bottom)
